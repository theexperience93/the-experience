  ...
  return (
    <div className="app">
      ...
      <div className="bottom-content">
        <p className="covid-information">
          The Experience has been postponed due to the Covid-19 situation. We
          will be back with more information at a later time. Until then, stay
          safe!
        </p>
        {featureToggle && <Form inputRef={inputRef} />}
